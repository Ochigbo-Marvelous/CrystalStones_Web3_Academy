...
export default function GoogleButton({ label = "Continue with Google" }) {
  return (
    <a className="su-google" href={`${API}/api/auth/google`}>
      <svg viewBox="0 0 48 48" width="18" height="18" aria-hidden="true">
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.3C29.3 35.1 26.8 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.5 5C9.6 39.6 16.3 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.2-4.2 5.5-7.6 6.5l6.3 5.3C37.3 41.3 44 36 44 24c0-1.3-.1-2.7-.4-3.5z"
        />
      </svg>
      {label}
    </a>
